    ...
    protected void handleSave() throws IOException {
        ...
        if (NotifyDescriptor.YES_OPTION.equals(result)) {
            ...
            else
            {
              ...
              Query queryDC = entityManager.createNamedQuery("DiscountCode.findAll");
              Collection<DiscountCode> resultListDC = queryDC.getResultList();
              DiscountCode dc = resultListDC.iterator().next();
              
              Query queryMM = entityManager.createNamedQuery("MicroMarket.findAll");
              Collection<MicroMarket> resultListMM = queryMM.getResultList();
              MicroMarket mm = resultListMM.iterator().next();
              
              customer.setCustomerId(resultList.size()+1);
              customer.setName(nameField.getText());
              customer.setCity(cityField.getText());
              //add more fields that will populate all the other columns in the table!
              customer.setAddressline1("Rio Hondo");
              customer.setAddressline2("Col. Progreso Tizapan");
              customer.setZip(mm);
